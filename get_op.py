...
Your job is to write a program that will return the correct operator to get num1 and num2 to the target variable.
...
def get_op(num1: int, num2: int, target: int) -> str:
